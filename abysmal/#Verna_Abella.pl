...
sub EVENT_SIGNAL {
	plugin::DiaWind("Well, don't ye look lovely today! Why, I can 'ardly think of what I want ta drink with ye distractin' me. 'ow about a light beer for now. I'll surely be orderin' more as long as yer on duty!");
}
