...
sub EVENT_ITEM {
	...
	if(plugin::check_handin(\%itemcount, 20197 => 1)) {
		plugin::DiaWind("You have done well, $name. Take this Rusty Bloodsaber Mace to a forge and clean it up with a Sharpening Stone. It may take you several attempts to get all the rust off if you are not familiar with the process. Once that is done take the Refined Bloodsaber Mace to Torin Krentar with a Giant King Snake Skin and he will put the finishing touches on the weapon.");
