...
sub EVENT_ITEM{
	if(plugin::check_handin(\%itemcount, 31754 => 1)){
		plugin::DiaWind("You've been sent by the Validus Custodus to question me!! You mortals are more foolish than I had presumed! The only information I have for you is the fact that you are about to face your death!!");
