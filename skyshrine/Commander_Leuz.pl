...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount,29688=>1)) {
    plugin::DiaWind("Well this artifact will definitely need study. Thank you for this report. Perhaps after we have researched this object more we will have more for you to search for.");
