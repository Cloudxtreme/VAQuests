...
sub EVENT_SAY {
   ...
   if($text=~/Hail/i){
      plugin::DiaWind("Finally, a servant worthy of my needs! Apparently you are of high status, which perhaps means you might know a master [jeweler] capable of faceting a very magical, yet fragile stone?");
   }
   if($text=~/jeweler/i){
      plugin::DiaWind("You must provide me with 2000 platinum pieces as a deposit, then you must take this stone to a master jeweler or [Darfumpel], have it faceted and return it to me along with an orb of pure crystal, a gold necklace the color of snow, and the [blood of Xenyari]. Do that and I will provide you with magic beyond that of most knights of darkness.");
   }
   if($text=~/darfumpel/i){
      plugin::DiaWind("Darfumpel is a gnomish shopkeeper here in the Rathe Mountains. He apparently has a new technique for gemcutting, however, he will not deal with me due to my affiliation with necromancy. Speak with him. Perhaps he might be willing to aid you for a price, but make sure you hide your true nature. He despises dark magic.");
   }
   if($text=~/blood of xenyari/i){
      plugin::DiaWind("Xenyari is a druid who inhabits these parts. She is rarely seen, however, I require a droplet of her blood. Here is the catch though, and one for which you may be well suited if you desire magic of the knights of darkness - Xenyari must give of herself willingly. In other words, you cannot take her blood by force. Rather, she must give you her blood of her own accord.");
   }
}
...
sub EVENT_ITEM {
   ...
   if($platinum>=2000) {
     plugin::DiaWind("Very well, $name. Take this gem to a master jeweler and return it to me with the other three items.");
     quest::summonitem(10191);
   }
   elsif(plugin::check_handin(\%itemcount,10192=>1,10147=>1,10218=>1,10196=>1)) {
     plugin::DiaWind("You are quite cunning. After I fashion this telesm, take it back to Xenyari. She would 'enjoy' another 'gift,' eh?");
     ...
     plugin::DiaWind("Oh! Umm... Well, I was just playing with you. Certainly you know I was joking! We had a deal and I will abide by the terms of our agreement. Here is my payment for your services. Bye..");
