sub EVENT_SAY{
	...
	if(($text=~/track down the defilers/i) && ($faction > 5)) {
		...
		if($random == 1) {
			plugin::DiaWind("Oh look..a talking lump of refuse..how novel!");
		}
	}
	if($text=~/Valdanov Zevfeer/i){
		plugin::DiaWind("Valdanov Zevfeer was a traveling alchemist and magical reagent peddler that used to occasionally visit Katta Castellum. At one point before the initial vampyre attacks he decided to remain in Katta Castellum for a while with the wealthy Katta citizen Nathyn Illuminious. Apparently that decision saved his life as according to the records you have provided the caravan he arrived with never completed the return trip to Shadow Haven. That is as much as I know about the individual as he primarily kept to himself during his stay here.");
	}
}

sub EVENT_ITEM{
	if(plugin::check_handin(\%itemcount, 18330 => 1)){
		plugin::DiaWind("I was afraid of this. I do not know how much Halle managed to tell you, but we have had our suspicions about one of the Legionnaires ever since she overheard him talking in his sleep. She was meant to get close to him, I guess she found something out... I should have been more careful!  Take this to Governor Markil, it concerns his men and I've no doubt he can handle it. Thank you much for your help.");
		quest::ding();
		quest::faction(52,50);
		...
		plugin::DiaWind("Most interesting. One of the names on this list I recognize. The alchemist [Valdanov Zevfeer]. Nathyn Illuminious would know more of Valdanov. Present this badge to Nathyn so that he knows you have been sent by the Magistrates to inquire about this issue and question him about the alchemist.");
		quest::ding();
		quest::faction(52,10);
		...
		plugin::DiaWind("There is much that is disturbing about these revelations. I will make sure the Validus Custodus is alert than they already are to the presence of powerful vampyre among our citizens. If you can find this Valdanov Zevfeer slay him and bring me his ashes your Katta Castellum Badge of Service, and your Magus Conlegium Token I will bestow upon you an honorable reward.");
		quest::faction(52,10);
		quest::faction(284,-30);
		quest::faction(142,-30);
		...
		if(plugin::check_handin(\%itemcount, 7397 => 1, 31757 => 1, 7394 => 1)) {
			plugin::DiaWind("You have done a great service for Katta Castellum and the Loyalist Empire. I award you for your honorable Services. Know that you will be remembered for your deeds.");
			quest::ding();
			quest::faction(52,10);
			quest::faction(284,-30);
			quest::faction(142,-30);
