sub EVENT_SAY {
  if($text=~/hail/i) {
    plugin::DiaWind("Hello, $name. Interested in the art of research? I have several tomes which may aid you in such a pursuit.");
  }
}
