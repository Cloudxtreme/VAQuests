...
{ 
	if($text=~/Hail/i)
	{
		plugin::DiaWind("Greetings, Borik Darkanvil, at your service. I was once a planar traveler like you. Those days are behind me, now I am content to earn my keep as a blacksmith, and to experiment with some of the [special recipes] that I have picked up in these outer planes."); 
	}
	elsif($text=~/special recipes/i)
	{
		plugin::DiaWind("Well a little bit of this and a little bit of that. If there is anything you need assistance in making come see me. I may be able to help.");
	}
	...
	elsif($text=~/forge them for me/i)
	{
		...
		if($skill_amount >= 60)
		{
			plugin::DiaWind("A smith of your skill does not need my assistance in making the box, however I won't turn away your money. Bring me three thousand platinum, the perilium, the brain, and the heart and I will make the box for you.");
		}
		else
		{
			plugin::DiaWind("If you return all three items to me I will do the work for you for, a mere three thousand platinum. I will not guarantee my success, but I can guarantee if you do not have the skill, you will fail.");
		}
	}
}
...
sub EVENT_ITEM
{
	if($platinum == 3000)
	{
		...
		{
			plugin::DiaWind("Ah ha! Here we go one box of souls!");
