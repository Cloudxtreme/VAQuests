    ...
    if (defined($qglobals{Wayfarer}) && ($qglobals{Wayfarer} == 1)) { #PC has spoken to home town Wayfarer recruiter but not received Adventurer's Stone
      ...
      if (!plugin::check_hasitem($client,41000)) { #PC does not have an Adventurer's Stone
        ...
        if ($ruj_wins < 2) {
          ...
          plugin::DiaWind("Perfect timing. I just put down my lute. Did you know the orcs were created by Rallos-Zek? Oh yes! They were bred for battle. Mighty creatures indeed and very determined. They rely on slaves, whether they be orcs or other creatures. Each orc seemingly belongs to another! Return soon for more $name. I'm sure we will spend a lot of time together!");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($ruj_wins >= 8) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::DiaWind("Just finishing up some bread. Let's make this quick. As I said before, each orc belongs to another. We know it's true. This makes the social order of the orcs very simple to follow. Each orc is property, all the way to the highest ranks. The highest ranks relate to one another a bit differently though. Unfortunately, I don't have much more detail that that! I wonder if this will help you defeat them? I don't know that, but I do think knowledge can be a weapon.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($ruj_wins >= 10) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::DiaWind("I've come to a part in my song that will have to move the audience to great anticipation! I think I shall use minor chords for that part, hm. So, yes $name, as Rujark face was bandaged until her scars healed, she easily fit among the male goblins. She refrained from speaking and loyally took orders from her battle master. They would often raid the orcs. In every fight, Rujark killed twice as many orcs as the rest. Rumors and fanciful stories began to get passed around the caves under the spine of the world. Must go, $name. I really want to finish this portion of my song.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($ruj_wins >= 40) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::DiaWind("Sorry to have ended so abruptly last time, my friend, but my song is better for it! As you most likely surmised, during the meeting of the nobles, Givlikk blurted out that Rujark was female. At first they didn't know what to make of the news. They were not certain Givlikk told the truth. Seeing the true motivations and greed of Rujark's brother, they began to believe him. They did accept that Rujark belonged on the battlefield, but they could not condone a female leading an army to war against the orcs. So, they sent a messenger to tell Rujark the nobles requested her presence. I fear I may need to write two songs to tell this story, my friend.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($ruj_wins >= 50) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::DiaWind("Hail $name. Well, the story about Rujark has a bit of a bitter ending which makes it perfect for my song. Over the years that Rujark trained and improved the goblins as the leader in the Rujarkian Hills, her brother Givlikk grew so envious that he became obsessed with ending his sister's life. Givlikk was shamed and punished for trying to sell his sister too. After all, to the goblins, Rujark was very much their divine mother that had been touched by the gods. Rujark kept her brother near to her because she trusted him. Hm, I need to add more notes to this part of the song.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($ruj_wins >= 58) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
