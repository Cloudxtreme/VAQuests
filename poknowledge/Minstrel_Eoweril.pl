...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 29112 => 1)) {#Ethereal Parchment
    ...
    plugin::DiaWind("Very interesting, I will share this with the other academics. Take this as a reward for your discovery."); #Real text still needed
