...
sub EVENT_ITEM {
	if (plugin::check_handin(\%itemcount, 18757 => 1)) { #tattered note
		plugin::DiaWind("Hmmm, I hope you're tougher than you look. Here, put this on. Go find Ulraz, he'll beat you into shape. There's no turning back now, punk. So, you'd better do well, got it?");
		quest::ding();
