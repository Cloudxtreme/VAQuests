...
sub EVENT_TIMER {
	plugin::DiaWind("You ever communed with a tree?  Most people just walk right past them and don't take the time to stop and really appreciate what that tree means.");
	quest::signal(160225,150);
	quest::settimer(1,1800);
}

sub EVENT_SIGNAL {
	plugin::DiaWind("It translates to 'Gift of the Dark' you fool!");
