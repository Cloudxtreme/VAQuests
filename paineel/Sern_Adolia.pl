...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 18019 => 1)) { # Harbingers of Fear Guild Note
    ...
    plugin::DiaWind("Well done, go now and continue your contemplations of fear. Keep up with your [duties] and you will soon be reaping the rewards granted by our Lord Cazic-Thule!!");
    ...
    plugin::DiaWind("Excellent job, $name. These components will help with our research immeasurably. You will soon be reaping the rewards granted by our Lord Cazic-Thule!! If you want to further assist our research effots, talk to Atdehim Sqonci.");
