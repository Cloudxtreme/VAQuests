...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 28291 => 1)) {
	plugin::DiaWind("It is a pleasure to meet you. I've heard a great deal about you from the other elders. Please give me a moment to scan over this for you.");
