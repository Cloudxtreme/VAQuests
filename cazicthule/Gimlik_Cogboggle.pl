...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 8723 => 1) && ($EventStage == 2)) { #Tiny Metal Quill
    ...
    plugin::DiaWind("I do not want this.");
...
sub EVENT_WAYPOINT_DEPART {
  if(($wp == 1) && ($EventStage == 1)) { #Home point
    plugin::DiaWind("Thank you for your assistance. If you found anything of importance during our adventure, I will gladly give you something in trade...");
    quest::stop();
    $EventStage = 2;
  }
