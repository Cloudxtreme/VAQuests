    ...
    if (defined($qglobals{Wayfarer}) && ($qglobals{Wayfarer} == 1)) { #PC has spoken to home town Wayfarer recruiter but not received Adventurer's Stone
      ...
      if (!plugin::check_hasitem($client,41000)) { #PC does not have an Adventurer's Stone
        ...
        if ($mmc_wins < 2) {
          ...
          plugin::DiaWind("$name, it is indeed good to see you again! As you probably figured out for yourself, the Nightrage and Savagefang are caught in an eternal vicious cycle. Mayong Mistmoore continues to be absent and unconcerned with the ways of the catacombs. Consumed with his own importance, as long as his minions remains constant and in balance, it is likely Mayong won't appear here to solidify the pecking order. That means it's up to us to keep these foul creatures under control.");
          $client->Message(15, "You have received an invaluable piece of information!");
          $client->Message(15, "Your Adventurer Stone glows with more power as you gain stature with the Wayfarers Brotherhood.");
          if ($mmc_wins >= 22) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          ...
          plugin::DiaWind("The Bloodguard and the Stewards have been turning their eyes to each other lately. It looks like the Bloodguard is preparing an offensive attack that will all but decimate the Stewards. Words came to me on the wings of a bat about the Stewards trying to convince the elite vampires that the Bloodguard were no longer necessary and tthat a political power struggle may be on the horizon. There was some mention of some strange ore deep within the caverns too.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($mmc_wins >= 46) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::DiaWind("The Stewards have been collecting some strange ore that carries a strong aura of magic. It's clear that even the wise Stewards are not sure what the ore is for. The Bloodguard have also begun too collect the ore. The lower classes of Mistmoore's Catacombs also have orders to find more of the mysterious fragments.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($mmc_wins >= 48) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::DiaWind("I think I'm beginning to understand those vampires better. I always wondered why they seemed to coexist quietly while their hated was so palpable it weighed on the air. And there was always death everywhere. During one excursion to the catacombs, I was observing from the inside of a coffin and I saw a silent assassin end the existence of one of the Trueborn. I surmised that assassinations among them must be frequent.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($mmc_wins >= 66) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::DiaWind("Well, I must say I'm impressed! You know as much as the Wayfarers Brotherhood about these dungeons that have been uncovered. Nicely done, $name!");
        }
        else {
