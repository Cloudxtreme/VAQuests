...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 9585 => 1)) { #9585 Magically Sealed Letter
    ...
    plugin::DiaWind("Interesting, I heard about your fight with the leader of the Disciples. I've never seen anything like this. Take it to Borik Darkanvil in the Plane of Knowledge. Return to me when you are done with him, in the meantime I will try to find information on where he went after your fight.");
