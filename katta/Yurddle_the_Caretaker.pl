...
sub EVENT_ITEM{
	if(plugin::check_handin(\%itemcount, 10670 => 1, 10673 => 1, 10672 => 1, 10671 => 1)) {
		plugin::DiaWind("I require the Aeridia Family Signet Ring, the Sealed Golden Scroll Tube, the Faded Silver Embroidered Robe, and the Tarnished Copper Runed Wand that were stolen from Holin Aeridias crypt.");
		plugin::DiaWind("Give this box to the ghost of Holin Aeridia.");
		quest::ding();
		...
		plugin::DiaWind("I require the Ancient Ornate Combine Dagger, Talikar Family Signet Ring, Faded Portrait of a Lady, and the Antique Platinum Medal that were stolen from Raien Talikars crypt.");
		plugin::DiaWind("Give this crate to the ghost of Raien Talikar.");
		quest::ding();
		...
		plugin::DiaWind("I require the Gold Embroidered Kilt, Silver Embroidered Tabard, Ancient Ceremonial Varhammer, and Old Sealed Medicine Pouch that were stolen from Shoeon Malicus' crypt.");
		plugin::DiaWind("Give this crate to the ghost of Shoeon Malicus.");
		quest::ding();
