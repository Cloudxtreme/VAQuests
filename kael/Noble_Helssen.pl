...
sub EVENT_ITEM {
	...
	if(plugin::check_handin(\%itemcount, 1722 => 1)){ #Helssen's Voucher
		plugin::DiaWind("Excellent choice, $race. Competence and a sense of style. When we are ready to take the Wakening I will most definitely welcome your participation. Here is your reward.");
		quest::ding();
