...
sub EVENT_SAY {
    ...
    if ( $qglobals{SkinSampleA} ) {
        plugin::DiaWind( "There is nothing more I can tell you, please take the ite"
    ...
    # initial contact
        ...
        plugin::DiaWind( "Greetings traveler, my name is Alexsa and I am currently "
    ...
    # quest accepted
        ...
        plugin::DiaWind( "Oh wonderful! You don't know how helpful this will be. Ta"
