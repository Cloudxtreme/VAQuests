sub EVENT_SAY {
  ...
  if($text=~/marais/i) {
    plugin::DiaWind("Do you have my ring? No? Then quit your yammering.");
  }
}

sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 29849 => 1)) { #Promise Ring
    plugin::DiaWind("Aye, this is it, did you kill her? Well anyway, here, I really didn't want this anymore- I was hoping some fool would give me something of value for it. Thanks.");
