...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 5558 => 1, 6158 => 1)) {
    plugin::DiaWind("Well done. Take this new cloak and wear it with pride. You can now be called journeyman!");
