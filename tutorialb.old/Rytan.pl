...
sub EVENT_SAY {
  if ($text=~/hail/i)  {
    if (quest::istaskactivityactive(22, 4)) {
      plugin::DiaWind("Hello $name. I'm not much of a fighter myself but I can bestow the power of my god's favor. Would you like to be [" . quest::saylink("blessed") . "]?");
    }
    else {
      plugin::DiaWind("Hello, $name. I'm not much of a fighter myself but I can bestow the power of my god`s favor. Would you like to be [" . quest::saylink("blessed") . "], or would you perhaps like to [" . quest::saylink("review") . "] my lessons from earlier?");
    }
    ...
    if (quest::istaskactivityactive(22, 4)) {
      ...
      if ($class eq "Warrior" || $class eq "Berserker" || $class eq "Monk" || $class eq "Rogue") { #Melee
        ...
        plugin::DiaWind("You seem to be a bit of a caster yourself. You will find that spells and songs can greatly enhance your power. Being a hybrid of sorts, you will have access to both magic and, later, skill tomes. For now, take this scroll. It may prove to be useful to you as you combat the kobolds. As you earn money and gain experience you will find other powerful spells. Some spells can be purchased from vendors, some can be made by players with tradeskills, and some must be obtained via quest. Good luck out there!");
        ...
        plugin::DiaWind("You seem to be a bit of a caster yourself. You will find that spells and songs can greatly enhance your power. Take this and scribe it in your spell book. I can only hope it helps you against the kobold horde. As you earn money and gain experience you will find other powerful spells. Some spells can be purchased from vendors, some can be made by players with tradeskills, and some must be obtained via quest. Good luck out there!");
...
sub REVIEW {
  ...
  plugin::DiaWind("You're a quick learner, my friend. Hopefully your magic can see us through the struggle ahead.");
}