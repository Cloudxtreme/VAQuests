...
sub EVENT_SAY {
  ...
  if ($text=~/hail/i) {
      plugin::DiaWind("Greetings! I am Timebender Aale. Through years of research into the temporal rifts in this area, I am able to create a portal to the past. Would you like to see the [" . quest::saylink("past version") . "] of this zone?");
  }
  if ($text=~/past version/i) {
          if($group) {
            ...
            quest::MovePCInstance(97, $InstanceDroga, 350.08, 1385.17, 3.75);
          }
        }
}
