...
sub EVENT_TIMER {
	...
	if ($timer == "warning") {
		plugin::DiaWind("Running out of ore soon, get em while they're hot!");
...
sub EVENT_SAY {
  if($text=~/Hail/i) {
    plugin::DiaWind("Good day to you, $name. New Tanaan holds a wealth of knowledge and opportunities to further yourself in more ways than mere talent of the mind. If you are a craftsman of steel and armor and seek to further progress your trade, then you have come to the right place. My inventory is quite plentiful and holds the necessary elements for any blacksmith's trade. I am also willing to pay those [willing to help] me restock my supply of high quality ore.");
  }
  if($text=~/willing to help/i) {
    plugin::DiaWind("Excellent! Simply fill this crate with either four large bricks or four small bricks of unrefined ore from Norrath and return it to me. I will provide you with coin and refine the ore for sale to the smiths of New Tanaan.");
...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 10953 => 1)) {#Large Shipment of High Quality Ore
    plugin::DiaWind("Thank you $name! I will prepare the ore for sale and be open for business again momentarily. Here is your payment for your services.");
    quest::exp(250);
