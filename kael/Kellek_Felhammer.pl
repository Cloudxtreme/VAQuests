sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 25279 => 1)){
    ...
    plugin::DiaWind("Here you go $name. I dunno why master Wenglawks trusts you with this but take it anyways and don't mess up.");
  ...
  # Handin: Voucher for spear 
    ...
    # Spear Delivery (kael)
    plugin::DiaWind("Another delivery eh? Be careful with this spear, if you break it I'll break you.");
