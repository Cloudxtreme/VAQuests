...
if($hpevent == (99)) {
$nexthp = $hpevent - 1;
#plugin::DiaWind("DEBUG: $nexthp is next ");
...
if ($hpevent == (10)) {
$entity_list->MessageClose($npc, 1, 500, 15, "Balance of Defense is restored.");
...
if ($signal == 1) {
#plugin::DiaWind("DEBUG: Recieved ");
quest::setglobal("Balance_of_Defense", $nexthp, 7, "M30");
quest::signalwith(298129,1,0);
}

if ($signal == 2) {
#quest::shout("DEBUG: Recieved Can now fight them. ");
quest::delglobal("Balance_of_Defense");
