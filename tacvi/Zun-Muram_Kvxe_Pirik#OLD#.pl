...
plugin::DiaWind("You shall regret trespassing into my chambers. The might of our kind shall smother the flames of life in this world, starting with you.!");
plugin::DiaWind("Do you really think your paltry skills will be enough to best a being as powerful as I?");
...
if ($hpevent == 91) {
plugin::DiaWind("Ha ha ha, you fools thought you could overpower me. You are nothing but food for my offspring. Come my children, strike them down and suck the marrow from their bones.");
...
if ($hpevent == 71) {
plugin::DiaWind("Your efforts shall fail no matter how great. This is a reality you shall soon see as your vile existence ceases and my brood consumes your remains. ");
quest::emote("body falls to the ground -- a lifeless husk freeing the hatchlings within.");
...
if ($hpevent == 51) {
plugin::DiaWind("You show surprising strength and conviction, but you will not get any further. The time has come for you to be destroyed.");
quest::emote("body falls to the ground -- a lifeless husk freeing the hatchlings within.");
...
if ($hpevent == 31) {
plugin::DiaWind("My resolve is waning but I shall fight you to the very last breath. The commander looks down upon weaklings in his ranks and the ikaav are not ones to indulge in it.");
quest::emote("body falls to the ground -- a lifeless husk freeing the hatchlings within.");
...
if ($hpevent == 10) {
plugin::DiaWind("The end is inevitable, but if I must be defeated, some of you will join me in the afterlife.");
$Reset = 1;
