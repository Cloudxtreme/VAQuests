...
#	if($count==1) {
  if ($timer eq "lecture") {
    quest::stoptimer("lecture");
    quest::settimer("lecture2",110);
  ...
  if($timer eq "lecture2") {
    quest::stoptimer("lecture2");
    quest::settimer("lecture3",110);
  ...
  if($timer eq "lecture3") {
    quest::stoptimer("lecture3");
    ...
    quest::settimer("lecture4",110);
  }

  if($timer eq "lecture4") {
    quest::stoptimer("lecture4");
    quest::settimer("lecture5",110);
    quest::settimer("lecture",25);
  ...
  if($timer eq "lecture5") {
    quest::stoptimer("lecture5");
    quest::settimer("lecture6",110);
  ...
  if($timer eq "lecture6") {
    quest::stoptimer("lecture6");
