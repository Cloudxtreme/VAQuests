...
sub EVENT_SAY { 
	if($text=~/hail/i){
		plugin::DiaWind("Greetings $name. are you one of our new recruits?"); 
	}
...
sub EVENT_ITEM { 
	if (plugin::check_handin(\%itemcount, 18849 => 1)) { # Khati Sha Guild Summons
		plugin::DiaWind("$name. welcome to the Animist's guild. You have grown strong in the safety of our city and it is now time for you to register for official citizenship of Shar Vahl. The Khati Sha. explorers of this hostile land. have granted your request of inclusion and deem you to be worthy of our training. Take this application to Registrar Bindarah and return to me with proof of your citizenship.");
