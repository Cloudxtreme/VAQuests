...
sub EVENT_SAY { 
	if($text=~/hail/i){
		plugin::DiaWind("Salutations! The Song Weavers are always glad to add a new voice to the choir.  In addition to your voice. will you also [fetch spiderling silk]?  We need some to replace our worn lute strings.  Carry out this task in high tempo and we will show our gratitude.");
	}
	if($text=~/spiderling silk/i){
		plugin::DiaWind("Very spirited of you!!  Gather four spiderling silk and return them to me.  Good hunting. my friend!!");
	}
	if($text=~/trades/i) {
...
sub EVENT_ITEM {
	if(plugin::check_handin(\%itemcount, 18783 => 1)){ #Tattered Note
		plugin::DiaWind("Greetings. friend. I am Sylia.  I see that you wish to join our humble guild.  Good.  Here is a gift for you - your guild tunic.  Once you are ready to begin your training please make sure that you see Sarialiyn Tranquilsong, She can assist you in developing your hunting and gathering skills. Return to me when you have become more experienced in our art, I will be able to further instructd you on how to progress through your early ranks, as well as in some of the various [trades] you will have available to you.");
	...
	if(plugin::check_handin(\%itemcount, 13099  => 4)) {
		plugin::DiaWind("Splendid job! Now if you can just keep a tune, you'll be a fine bard.");
