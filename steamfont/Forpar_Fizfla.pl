...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 20378 => 1)) { #Note to Forpar Fizfla
    ...
    plugin::DiaWind("Wow! I didn't think a $race like you would be able to gather all of those things.");
    ...
    plugin::DiaWind("Now, do you want to gather the next pieces for me?");
  }
  elsif (plugin::check_handin(\%itemcount, 11602 => 1, 11622 => 1, 16905 => 1)) { #White Dragon Scales, Red Dragon Scales, Metal Bits
    plugin::DiaWind("Wooooooo! You are doing a wonderful job, $name. I wish I could go out and gather these things myself.' Forpar sits back down at his desk and pulls several very strange looking tools out. Eventually he looks up at you and says, 'The body is done! Only one more piece to go!");
    ...
    plugin::DiaWind("Goodness! I can hardly contain myself! This will be my greatest creation ever!");
    ...
    plugin::DiaWind("I hope you find a good use for that! I bet you could play it from the mountaintops and the people below would hear you. Thank you, $name, for making my lifelong dream come true!");
