...
sub EVENT_ITEM {
   if (plugin::check_handin(\%itemcount, 18768 => 1)) {
		plugin::DiaWind("Welcome, we are the Paladins of the Underfoot. I am Datur, and I will help teach you the word and will of the Duke of Below, Brell Serilis. Here is our guild tunic. Let's get started, shall we?");
   ...
   if (($faction <= 4) && (plugin::check_handin(\%itemcount, 12279 => 1))) {
      plugin::DiaWind("The chalice is returned!! Praise be to Brell!! You have proven yourself to our church and have earned our respect. Let me welcome you into our brotherhood with the Cape of Underfoot. Wear it with pride as all of our finest paladins do.");
      quest::faction(44, 25);
