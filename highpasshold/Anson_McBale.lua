function event_say(e)
	...
	if(fac <= 5) then
		...
		elseif(e.message:findi("see stanos") and class == "Rogue" and level >= 1) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 28014}) and e.other:GetClass() == "Rogue" and e.other:GetLevel() >= 1) then
		e.self:Say("Oh, I see.");
		eq.spawn2(5088,0,0,336,10,45,225);
	end
