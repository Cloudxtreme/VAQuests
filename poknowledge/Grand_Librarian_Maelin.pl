sub EVENT_SAY {
	if(quest::istaskactive(220)){
       	if ($text=~/trick or treat/i) {
                        plugin::DiaWind("Ah, here you go. Fresh from the Sugar Assembalage 2000.");
	...
	if (plugin::check_hasitem($client, 29165)){
		if ($text=~/Hail/i) {
			plugin::DiaWind("The Quintessence! Oh my this is amazing! I have come into contact with Chronographer Muon in the realm of innovation. Go to him, show him you have the power to activate machine. I shall meet you there, this I must see!");
		}
	}
