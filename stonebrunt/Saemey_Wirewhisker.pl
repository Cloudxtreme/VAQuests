...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 6980 => 1, 6977 => 1)) { #Kejek Spirit Powder, Soul Orb
    plugin::DiaWind("I require a Soul Orb and Kejek Spirit Dust in order to perform the ritual that will free the imprisoned souls.");
