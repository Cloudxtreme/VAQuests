...
sub EVENT_ITEM {
   if($faction < 3) {
    ...
    plugin::DiaWind("I do not know you well enough to entrust you with such an item, yet."); #Made up text
  }
}