sub EVENT_SAY {
  ...
  if(($class eq "Cleric") && ($race eq "Dark Elf")) {
    ...
    plugin::DiaWind("I'm sorry but I will only deal with Clerics that are willing to prove their loyalty to Innoruuk.");
  }
}
