...
sub EVENT_SAY { 
	if($text=~/hail/i){
		plugin::DiaWind("Hail. are you here to assist with something specific or just looking for something to do.");
	}
	...
	if ($text=~/essence of sonnet/i) {
		...
		plugin::DiaWind("An essence of sonnet? I have never produced such a thing my friend, though the fact that you would even request one from me is very flattering.' His eyes leave your face and settle off in the distance somewhere as he continues, 'I was present once when one was created... it was beautiful. I was only a child, but there was no mistaking the significance. Oh how I would love to produce such a thing myself- an accomplishment without peer for one of my art. They say that the inspiration must be genuine, should you know of something that could inspire me so then by all means, I will see if I have an essence of sonnet within me.");
	}
}

sub EVENT_ITEM { 
	if(plugin::check_handin(\%itemcount, 18324 =>1 )) {
		plugin::DiaWind("Thanks, $name!  That is a wonderful story of inspiration.");
		quest::summonitem(5991);
	}
	elsif(plugin::check_handin(\%itemcount,18552 => 1)) { # Hymnist Guild Summons
		plugin::DiaWind("Our newest instrumentalist arrives! You have grown strong in the safety of our city and it is time now for you to repay our society. The Jharin. keepers of our history. accept you and deem you to be worthy of our training. Take this application to Registrar Bindarah and return to me with proof of your citizenship.");
		...
		plugin::DiaWind("This item. by itself. means nothing to me.");
		plugin::DiaWind("$name. citizen of Shar Vahl. accept this cloak as a symbol of your loyalty and service to our noble people. It will grow with you. young initiate. and like you it has incredible potential. Present your slate of citizenship to Gherik and he will guide you through your early training. May your songs inspire us all!");
		...
		plugin::DiaWind("These are finely crafted indeed, $name. Merchant Fahaar told me you were quite the prodigy, but don't tell him I told you that. Take this receipt and show it to Fahaar and tell him the king is quite pleased with both your work, and his teaching!");
		quest::exp(1000);
		quest::ding();
