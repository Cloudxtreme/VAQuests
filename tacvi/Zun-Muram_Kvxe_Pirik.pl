...
plugin::DiaWind("aggro $combat_state x ");
$client->Message(15, "Debug: New stats $AtkHit , $HasteHit , $NewAC, $MaxHit and $TooLow x $TooHigh x $OkHigh x $OkLow");
plugin::DiaWind("Balance check: Defense is $qglobals{Balance_of_Defense} ");
plugin::DiaWind("Balance check: Rage is $qglobals{Balance_of_Rage} ");
plugin::DiaWind("Balance check: Fury is $qglobals{Balance_of_Fury} ");
plugin::DiaWind("Balance check: Speed is $qglobals{Balance_of_Speed} ");
...
if (($text =~/hail/i) && ($name =~/Kayen/i)) {
plugin::DiaWind("NO aggro $combat_state x ");
$client->Message(15, "Debug: New stats $AtkHit , $HasteHit , $NewAC, $MaxHit and $TooLow x $TooHigh x $OkHigh x $OkLow");
plugin::DiaWind("Balance check: Defense is $qglobals{Balance_of_Defense} ");
plugin::DiaWind("Balance check: Rage is $qglobals{Balance_of_Rage} ");
plugin::DiaWind("Balance check: Fury is $qglobals{Balance_of_Fury} ");
...
plugin::DiaWind("Come you fools! Show me your strongest warrior and I will show you my first victim");
$npc->SetOOCRegen(0);
