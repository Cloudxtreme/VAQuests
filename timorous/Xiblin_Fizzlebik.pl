...
sub EVENT_SIGNAL {
	...
	if($signal == 3) {
		plugin::DiaWind("I didn't say anything! Now get back on your side of the island, you're getting dirt and junk all over mine!");
	}
}
