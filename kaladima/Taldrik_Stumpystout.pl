...
sub EVENT_ITEM {
	...
	# Disciple Symbol of Brell Serilis
		plugin::DiaWind("Ah ha! So ye are Bronlors chosen aye? Well den these fine brews can only mean one thing! Yep its dat youre a drinker like meh! Arg, if I only had me [recipe].");
	}
