...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 67617 => 1)) { # Prathun's Writings
    ...
    plugin::DiaWind("I thought I would never have to face this reality, but here it is -- the proof I asked for. While these pages detail the adventures of my love, it is you who are the great one. While I shall forever be pained by this, I am in your debt for helping me. Please leave me now and find those others who suffer the continued disappearance of their loved ones. If you have already helped everyone, please tell De'van that your task is complete and he will reward you.");
...
sub EVENT_SIGNAL {
	plugin::DiaWind("Malt for me!  Thanks!");
}
