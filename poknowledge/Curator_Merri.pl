...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 28082 => 1)) {#Collection of Idols
    plugin::DiaWind("Thank you very much $name!  Here, please accept this as a reward for the fine work you've done.");#Text made up, can't find a reference
