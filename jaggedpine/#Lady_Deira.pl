...
sub EVENT_ITEM {
  if ($faction <= 2) {
   ...
   if (plugin::check_handin(\%itemcount, 8952 => 1)) {
      ...
      plugin::DiaWind("Welcome to the Veterans of the Storm, and we honor you as Tempest Guard $name. Bear this symbol in humility and as a sign of your eternal pledge in service and protection of all that The Rainkeeper holds dear and sacred.");
