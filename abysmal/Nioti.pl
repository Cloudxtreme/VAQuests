...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 19140 => 4)) { # Branch of Sylvian Oak
    ...
    plugin::DiaWind("Thanks. I hope that wasn't too much trouble. Seems we need more help. Grumby just informed me that some parts on the bridge have already been damaged by rust. That doesnt sound good at all. We will need your help to get some sort of anti rust agent. What? Hey, dont get mad at me. I am sorry I keep asking for help, but I am just following Grumby's orders. There is a gnomish tinker in Ak'anon named Gilipus that might have something to help us. Go there and hand him this note along with your badge so he knows you are working for Grumby. I promise to reward you for your time when you are done helping us. Take your badge back and give it to me again when you hand in the anti-rusting agent."); 
    quest::exp(60000);
    ...
    plugin::DiaWind("Looks like your work here is done. Grumby said I can reward you. Here you go. Thanks again and sorry for all the trouble.");  
    quest::exp(200000);
