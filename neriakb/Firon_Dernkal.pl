...
sub EVENT_ITEM{
	...
	if(plugin::check_handin(\%itemcount, 21975 => 1, 21976 => 1, 21977 => 1, 21978 => 1)) {#Bronze Medallion of Service, Silver Medallion of Service, Golden Medallion of Service, Platinum Medallion of Service
		plugin::DiaWind("This is terrible news most definitely. I do not know how this could have happened. Gerod was one of the most skilled weapon masters that the Brotherhood has ever seen. I do certainly appreciate your work and dedication to this matter, please take this charm as a token of my appreciation.");
