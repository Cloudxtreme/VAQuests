sub EVENT_SAY { 
   if ($text=~/hail/i) {
      if ($faction <= 7) {
         plugin::DiaWind("How is life treating you, bud? What are you doing around the mines? Either you are a [member of 628] or you are lost. If you are lost, I can't help you. I ain't no guide.");
      }
      else {
      ...
      if ($faction <= 4) {
         plugin::DiaWind("It's my duty to assign [guild tasks] to all new members of Mining Guild 628.");
      }
      elsif ($faction <= 5) {
      ...
      if ($faction <= 4) { # Requires high amiable on live
         plugin::DiaWind("So you want to earn a parrying pick? Consider it an honor that I am even speaking of this with you. The guild had these picks made just for us. It is a magic item used to fend off attacks. Before you can have one, you will have to do me a [great favor].");
      }
      elsif ($faction <= 5) {
         plugin::DiaWind("Don't take this personally, but I can't quite trust you with such matters. Maybe a few less Butcherblock bandits would prove your worth.");
      }
...
sub EVENT_ITEM {
   if (plugin::check_handin(\%itemcount, 13931 => 4)) { # RunnyEye Warbeads
      plugin::DiaWind("Good work. We shall add these to the stash. Here is your reward, as promised. Be happy with it and continue your work. Maybe soon you shall be able to [earn a parrying pick].");
      ...
      plugin::DiaWind("Excellent work!! You are quite an asset to this mining guild. Please accept this Parrying Pick 628 for your great service. If you truly wish to serve our guild. Go and speak with Mater. Tell him you are [ready to earn Mining Pick 628].");
      quest::faction(220, 10); # Miners Guild 628
      quest::faction(33, -10); # Circle Of Unseen Hands
      quest::faction(29, -10); # Butcherblock Bandits
      quest::faction(77, 10);  # Deeppockets
