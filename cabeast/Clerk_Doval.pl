...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 18250 => 1)) { #Legion Order (all signed)
    plugin::DiaWind("Thank you so much. I am so glad I did not have to deal with such a rowdy band of troopers as these. Please take some coin and perhaps a book from my personal library.");
