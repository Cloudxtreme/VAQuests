sub EVENT_SAY
{
	if($text=~/hail/i)
		{
		plugin::DiaWind("Greetings $name! Nice to meet you. I've started up a complimentary bag check service. Feel free to give me your weight reducing bag, and I'll give you a token in return. When you would like to get your bag back, simply return to me with your token.");
		}
}
...
#The item turn ins are in alpha-numeric order
{
  if (plugin::check_handin(\%itemcount, 33233 => 1)) { #Ambleshifts Amazing Automated Amalgamator
    plugin::DiaWind("Here you go. Bring this token back to me when you would like your bag back.");
    quest::summonitem(93665);
  }
  elsif (plugin::check_handin(\%itemcount, 93665 => 1)) {
    plugin::DiaWind("Here you go. Here is your bag back.");
