...
sub EVENT_ITEM {
  if (defined($qglobals{bic}) && ($qglobals{bic} == 18)) {
    if (plugin::check_handin(\%itemcount, 67564 => 1)) {
      plugin::DiaWind("Ah, perfect. I am glad you were successful in finding it. Now, if you will give me one second I will condense the shard into concentrated energy which you can add to your stone. There we are. Please take the time to attach this, but make sure you do it in the order I mentioned when we first spoke.");
