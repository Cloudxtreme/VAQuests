...
sub EVENT_SAY {
	...
	if(($text=~/cloak/i) && ($qglobals{Shar_Vahl_Cit} == 7)){
		plugin::DiaWind("Someone found a rockhopper chewing on this in the pit. Try not to lose it this time.");
