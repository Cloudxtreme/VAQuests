...
sub EVENT_SAY { 
	...
	if(($text=~/cloak/i) && ($qglobals{Shar_Vahl_Cit} == 7)){
		plugin::DiaWind("Someone found this stuck in the top of a palm tree in the center of the plaza. I don't even want to know how it got there, just try not to lose it this time.");
